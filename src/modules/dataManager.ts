...
export default class DataManager {
	...
	async updateData(inputData: Partial<GuildStructureType>, dataToUpdate: (UpdateQuery<GuildStructureType> | UpdateWithAggregationPipeline)): Promise<GuildStructureType | null> {
		if (this.manager.database?.State !== true) return null;
